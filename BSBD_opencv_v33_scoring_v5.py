...
#match/area image
img_ma = cv2.imread('/home/monkey/Desktop/cornhole/image processing/images/match_area10.png')
...
time.sleep(0.5)
ser_but = serial.Serial ("/dev/ttyAMA3", 115200)
